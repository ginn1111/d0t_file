...
end, { silent = true, desc = "Clear log" })
keymap.set("n", "<leader>vsd", "<C-W>vgd<cr>", { silent = true })
keymap.set("n", "<leader>Wd", "<C-W>c<Cmd>:bd<cr>", { desc = "Delete window and buffer", silent = true })
